...
export function ProductImages({ images, thumbnailImage }: Props) {
  ...
  return (
    <div className="flex flex-col gap-y-2 sm:gap-y-6 items-start w-full">
      <div className="w-full aspect-square overflow-hidden rounded-xl flex items-center justify-center border bg-accent stroke-1 stroke-muted">
        {selectedImage ? (
          <img
            src={selectedImage}
      ...
      {images.length > 0 && (
        <div className="w-full overflow-x-auto scroll gap-x-1 flex items-center justify-start">
